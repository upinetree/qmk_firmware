...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * +---------+---+--+---+--+---+--+---+--+---+--+---+--+---+--+---+--+------+-+--------+
   * |    Shift    |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   Space   |  KANA  |
   * +-------------+------+------+------+------+------+------+------+------+----+--------+
   *                      | J1L  | J1C  | J1R  |      | J1L  | J1C  | J1R  |
   *                      +------+------+------+      +------+------+------+
   */
    [_BASE] = LAYOUT(
        ...
        TD_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    TD_SPC,  TD_KANA,
   ...
   */
    [_NUMS] = LAYOUT(
        ...
        _______, XXXXXXX, KC_BSLS, KC_GRV,  KC_LBRC, KC_MINS, KC_EQL,  KC_RBRC, KC_QUOT, KC_SCLN, _______,
        _______, KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
   ...
   */
    [_SYMS] = LAYOUT(
        ...
        _______, XXXXXXX, KC_PIPE, KC_TILD, KC_LCBR, KC_UNDS, KC_PLUS, KC_RCBR, KC_DQUO, KC_COLN, _______,
        _______, KC_LABK, KC_RABK, KC_QUES, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
			  _______, _______, _______,          _______, _______, _______ 
    ),
   ...
   */
    [_FUNC] = LAYOUT(
        ...
        KC_DEL,  KC_LALT, KC_LGUI, KC_APP,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
			  _______, _______, _______,          _______, _______, _______ 
    ),
   ...
   */
    [_GAME] = LAYOUT(
        ...
        _______, KC_A,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,    KC_I,    _______,
        _______, KC_LALT, KC_LGUI, KC_APP,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
			  _______, _______, _______,          _______, _______, _______ 
    ),
};
